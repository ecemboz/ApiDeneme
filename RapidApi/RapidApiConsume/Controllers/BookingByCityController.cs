		...
		public async Task<IActionResult> Index(string cityID)
		{
			if (!string.IsNullOrEmpty(cityID))
			{
				...
				var request = new HttpRequestMessage
				{
					...
					RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v1/hotels/search?checkout_date=2024-07-15&order_by=popularity&filter_by_currency=EUR&include_adjacency=true&children_number=1&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&room_number=1&dest_id={cityID}&dest_type=city&adults_number=2&page_number=0&checkin_date=2024-07-10&locale=en-gb&units=metric&children_ages=5%2C0"),
					Headers =
				{
